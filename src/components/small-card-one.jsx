const Jonathan = () => {
    return (
        <div className="p-7 rounded-xl shadow-lg flex flex-col bg-veryDarkGrayishBlue">
            <div className="flex flex-row space-x-5">
                <img src="..\src\assets\images\image-jonathan.jpg" alt="Jonathan Walters" className="rounded-full w-100" />
